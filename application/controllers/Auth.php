...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'botsistem666@gmail.com',
            'smtp_pass' => 'obama1UDIN',
            'smtp_port' =>  465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('botsistem666@gmail.com', 'bot sistem');
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('massage', '<div class="alert
            alert-success" role="alert">Password has been change! Please Login</div>');
            redirect('auth');
        }
    }
}
